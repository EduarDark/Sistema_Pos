...
class ModeloCliente
{
    ...
    static public function mdlActualizarAcceso($fechaHora, $id){
        $stn-Conexion::conectar()->prepare("update cliente set ultimo_login-'$fechaHora' where id_cliente-'$id'");
    ...
    static public function mdlEditCliente($data){
        ...
        $stmt=Conexion::conectar()-> prepare("update cliente set password='$password', perfil='$perfil', estado='$estado' where
        id_cliente=$id");
    ...
    static public function mdlEliCliente($id){
        $stmt=Conexion::conectar()-> prepare("delete from cliente where
        id_cliente=$id");
