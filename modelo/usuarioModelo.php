...
class ModeloUsuario
{
    ...
    static public function mdlActualizarAcceso($fechaHora, $id){
        $stn-Conexion::conectar()->prepare("update usuario set ultimo_login-'$fechaHora' where id_usuario-'$id'");
    ...
    static public function mdlEditUsuario($data){
        ...
        $stmt=Conexion::conectar()-> prepare("update usuario set password='$password', perfil='$perfil', estado='$estado' where
        id_usuario=$id");
    ...
    static public function mdlEliUsuario($id){
        $stmt=Conexion::conectar()-> prepare("delete from usuario where
        id_usuario=$id");
